...
class Input:
    ...
    @staticmethod
    def get_mrel() -> pygame.Vector2:
        return pygame.Vector2(pygame.mouse.get_rel())

    def set_mpos(self, pos: pygame.Vector2):
        pygame.mouse.set_pos(pos)
        self.mx, self.my = pos

    @staticmethod
    def get_mvisible() -> bool:
        return pygame.mouse.get_visible()

    @staticmethod
    def set_mvisible(vis: bool):
